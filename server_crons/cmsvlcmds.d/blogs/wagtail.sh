...
cmshomepage='http://www.wagtail.io';
cmslatestvurl='https://raw.githubusercontent.com/torchbox/wagtail/v1.0/docs/releases/index.rst';
cmsdescrip='NA';
...
cmslatestversion=$(curl $curlargs $cmslatestvurl |head -n7 |tail -n1 |sed 's/   //g');
