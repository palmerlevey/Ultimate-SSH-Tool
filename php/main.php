...
?>
echo "Loaded SSHTool $a0 Last Pulled @ $a1 | Loaded/used on $(curl -s http://repo.servergur.us/sshtool/php/stats.php | grep -o '[0-9]\+') servers!"
if [ -f /root/support/.ssht.msg ]; then
echo " "
echo -e "\\033[0;39m[\\033[1;33mSERVER NOTE\\033[0;39m]";
